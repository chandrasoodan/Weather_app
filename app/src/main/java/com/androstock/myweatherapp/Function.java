...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "f9b97f9267950bdc1115cb0fc427c87f";
	 ...
	 public static class placeIdTask extends AsyncTask<String, Void, JSONObject> {
		...
		protected void onPostExecute(JSONObject json) {
			...
			if(json != null){
				...
				String temperature = String.format("%.2f", main.getDouble("temp"))+ " F";
	...
	public static JSONObject getWeatherJSON(String name){
		try {
            ...
            Log.e("ddd", String.valueOf(connection.getResponseCode()));
